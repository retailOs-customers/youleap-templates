    ...
    <div dir="rtl" className="min-h-screen bg-neutral-50 p-8 font-asimon">
      ...
      <div className="mb-10 flex flex-col items-center gap-6 rounded-xl border border-neutral-100 bg-white p-8 shadow md:flex-row md:items-stretch">
        ...
        <div className="grid flex-1 grid-cols-2 gap-6 text-center text-base md:grid-cols-7">
          <div>
            ...
            <div className="font-bold break-words text-zinc-900 sm:break-normal">תאי מרקט (2008) בע"מ</div>
          </div>
          <div>
            <div className="text-neutral-500">איש קשר</div>
            <div className="font-bold break-words text-zinc-900 sm:break-normal">משה בן יוסף</div>
          </div>
          <div>
            <div className="text-neutral-500">מייל</div>
            <div className="font-bold break-words text-zinc-900 sm:break-normal">Sales@thaimarket.co.il</div>
          </div>
          <div>
            <div className="text-neutral-500">טלפון</div>
            <div className="font-bold break-words text-zinc-900 sm:break-normal">052-3289599</div>
          </div>
          <div>
            <div className="text-neutral-500">עיר</div>
            <div className="font-bold break-words text-zinc-900 sm:break-normal">תל מונד</div>
          </div>
          <div>
            <div className="text-neutral-500">יתרת חוב</div>
            <div className="font-bold break-words text-zinc-900 sm:break-normal">4,229</div>
          </div>
          <div>
            <div className="text-neutral-500">אובליגו</div>
            <div className="font-bold break-words text-zinc-900 sm:break-normal">40,000</div>
          </div>
        </div>
      </div>
      ...
      <div className="mb-16 grid grid-cols-1 gap-6 md:grid-cols-3">
        {[
          ...
          >
            <ArrowCircleRightIcon className="mb-2 h-8 w-8 text-black" />
