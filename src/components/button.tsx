...
const styles = {
  ...
  colors: {
    'dark/zinc': [
      'text-black [--btn-bg:var(--color-primary-200)] [--btn-border:var(--color-zinc-950)]/90 [--btn-hover-overlay:var(--color-white)]/10',
    ...
    blackwhite: ['text-white [--btn-bg:black] [--btn-border:black] [--btn-hover-overlay:white]/10'],
  },
