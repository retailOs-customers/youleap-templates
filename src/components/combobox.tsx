      ...
      >
        <Headless.ComboboxInput
          ...
          className={clsx([
            ...
            // Horizontal padding
            'pr-[calc(--spacing(3.5)-1px)] pr-[calc(--spacing(10)-1px)] sm:pr-[calc(--spacing(3)-1px)] sm:pr-[calc(--spacing(9)-1px)]',
            // Typography
...
>) {
  ...
  return (
    <Headless.ComboboxOption
      ...
      className={clsx(
        // Basic layout
        'group/option grid w-full cursor-default grid-cols-[1fr_--spacing(5)] items-baseline gap-x-2 rounded-lg py-2.5 pr-2 pr-3.5 sm:grid-cols-[1fr_--spacing(4)] sm:py-1.5 sm:pr-2 sm:pr-3',
        // Typography
