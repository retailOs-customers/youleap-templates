  ...
  return (
    <span
      ...
      className={clsx(
        ...
        'has-[[data-slot=icon]:first-child]:[&_input]:pr-10 has-[[data-slot=icon]:last-child]:[&_input]:pl-10 sm:has-[[data-slot=icon]:first-child]:[&_input]:pr-8 sm:has-[[data-slot=icon]:last-child]:[&_input]:pr-8',
