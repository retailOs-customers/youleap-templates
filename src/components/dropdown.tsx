...
export function DropdownItem({
  ...
  let classes = clsx(
    ...
    // Icons
    '*:data-[slot=icon]:col-start-1 *:data-[slot=icon]:row-start-1 *:data-[slot=icon]:-mr-0.5 *:data-[slot=icon]:ml-2.5 *:data-[slot=icon]:size-5 sm:*:data-[slot=icon]:ml-2 sm:*:data-[slot=icon]:size-4',
    '*:data-[slot=icon]:text-zinc-500 data-focus:*:data-[slot=icon]:text-white dark:*:data-[slot=icon]:text-zinc-400 dark:data-focus:*:data-[slot=icon]:text-white',
    // Avatar
    '*:data-[slot=avatar]:-mr-1 *:data-[slot=avatar]:ml-2.5 *:data-[slot=avatar]:size-6 sm:*:data-[slot=avatar]:ml-2 sm:*:data-[slot=avatar]:size-5'
  )
